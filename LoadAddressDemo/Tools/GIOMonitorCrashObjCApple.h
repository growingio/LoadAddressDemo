...
// files, arranged for use in GIOMonitorCrashObjC.

#ifndef HDR_GIOMonitorCrashObjCApple_h
#define HDR_GIOMonitorCrashObjCApple_h
...
// GIOMonitorCrash: The original values wouldn't have worked. The slot shift and mask
// were incorrect.
#define TAG_COUNT 8
...
#endif // HDR_GIOMonitorCrashObjCApple_h
